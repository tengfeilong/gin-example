...
// 2019-01-10 18:37:06.3244115 +0800 CST m=+0.066003801
...
var doc = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/controller/articles/addArticles": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "/controller/articles/deleteArticles/{id}": {
            "delete": {
                "produces": [
                    "application/json"
                ],
        ...
        "/controller/articles/editArticles/{id}": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "/controller/articles/getArticles/{id}": {
            "get": {
                "produces": [
                    "application/json"
                ],
        ...
        "/controller/articles/getArticlesList": {
            "get": {
                "produces": [
                    "application/json"
                ],
